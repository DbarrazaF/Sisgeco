...
public class Validar {
    ...
    public void validarSoloRut(JTextField campo){
        
        campo.addKeyListener(new KeyAdapter(){
            @Override
            public void keyTyped(KeyEvent e){
                char c=e.getKeyChar();
                int n=(int) e.getKeyChar();
                if(!Character.isDigit(c) && n!=45 && n!=107 ){
                    
                    e.consume();
                     
                }
                //valida que solo se permita campos - y k
                if((c=='-'&& campo.getText().contains("-") )||( c=='k' && campo.getText().contains("k"))){
                    e.consume();
                }
            } 
        });       
    ...
    public void validarTelefono(JTextField campo){
        ...
        campo.addKeyListener(new KeyAdapter(){
            ...
            public void keyTyped(KeyEvent e){
                ...
                //valida que solo se permita campos -
